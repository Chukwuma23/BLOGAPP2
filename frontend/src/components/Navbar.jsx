...
const Navbar = () => {
  ...
  return (
    <>
      {/* Navbar */}
      <nav className="w-full h-16 md:h-20 flex items-center justify-between bg-white shadow-md px-4 md:px-8 fixed 
      top-0 z-10 relative right-30">
        {/* LOGO */}
