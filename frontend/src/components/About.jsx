...
import Chima from '/public/chima.jpg';
...
const About = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 mb-12">
            ...
            <p className="text-gray-600">
             We combine creative design with technical excellence to deliver solutions
      ...
      {/* Footer */}
      <footer className="bg-gray-800 text-white py-12 rounded">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
              ...
              <div>
                ...
                <div className="flex items-center mb-4">
                  <div className=" w-12 h-12 bg-indigo-500 rounded-full flex items-center justify-center mr-4">
                    <img src={Chima} alt="Chukwuma Isaac" className="w-full h-full rounded-full" />
                  </div>
                  <div>
                    <p className="font-medium">Chukwuma Isaac kalu</p>
                ...
                <div className="flex space-x-4">
                  {/*  GitHub */}
                  <a href="https://github.com/Chukwuma23" className="text-gray-400 hover:text-white transition-colors">
                  ...
                  {/* LinkedIn */}
                  <a href="https://www.linkedin.com/in/chukwuma-isaac-120494261?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" className="text-gray-400 hover:text-white transition-colors">
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                      <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/>
                    </svg>
                  </a>
                  {/* facebook */}
                  <a href="https://www.facebook.com/chima.kalu.3572" className="text-gray-400 hover:text-white transition-colors">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 320 512" xmlns="http://www.w3.org/2000/svg">
              ...
              <div>
                ...
                <ul className="space-y-3">
                  <li className="flex items-center">
                    ...
                    <span>chukstechservice23@gmail.com</span>
                  </li>
                  <li className="flex items-center">
                    <svg className="w-5 h-5 text-indigo-400 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                    </svg>
                    <span>+234 5696-1874</span>
                  </li>
                  <li className="flex items-start">
                    ...
                    <span>Rivers State, Port-Harcourt<br />NIGERIA </span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="border-t border-gray-700 mt-8 pt-8 text-center text-gray-400">
              <p>&copy; 2025 Digital Creations. <a href='#' className="text-gray-400 hover:text-white transition-colors">All rights reserved.</a></p>
            </div>
          </div>
        </div>
      </footer>
